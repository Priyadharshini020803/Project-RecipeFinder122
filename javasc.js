function getRecipes() {
    ...
    // Simulated recipes based on ingredients (including YouTube video links)
    const sampleRecipes = [
        ...
        { 
            ...
            videoUrl: 'https://youtu.be/sVNQIbuv_Mc?si=xqzqPnJEmt7eTvMJ'  // YouTube video link for Paneer Butter Masala
        },
        { 
            name: 'Masala Dosa', 
            ingredients: ['rice flour', 'urad dal', 'water', 'oil'], 
            videoUrl: 'https://youtu.be/IDNtiYTd7_M?si=wfoQR9i59CDUu4HH'  // YouTube video link for Dosa
        }
    ];
    ...
    if (matchingRecipes.length === 0) {
        ...
        matchingRecipes.forEach(recipe => {
            ...
            // Append the video link to the list item
